            ...
            <div class="box-acoes out">
                <div class="acoes">
                    ...
                    <div class="modal fade" id="modalAdicionar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                        <div class="modal-dialog modal-professor" role="document">
                            <div class="modal-content modal-professor">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    <p class="modal-title">Digite o Nome do <span class="destaque">Professor</span> que Deseja Adicionar</p>
                                </div>
                                <div class="modal-body">
                                    <form method="post">
                                        <div class="box-frm-campos">
                                            <input type="text" name="nome_professor" required>
                                            <span class="floating-label">Nome do Professor:</span>
                                        </div>
                                        <div class="box-frm-campos">
                                        ...
                                        <div class="box-frm-campos">
                                            <input type="password" name="senha_professor" required>
                                            <span class="floating-label">Senha</span>
                                        </div>
                                        <div class="box-frm-campos">
                                            <input type="text" name="idsenac_professor" required>
                                            <span class="floating-label">ID Senac:</span>
                                        </div>
                                        <div class="box-frm-campos">
                                            <label for="tipo_professor" class="legenda">O usu&aacute;rio ser&aacute;:</label>
                                            <div class="box">
                                                <input type="radio" name="tipo_professor" id="Admin" value="A">
                                                <label class="legenda2" for="Admin">Administrador</label>
                                            </div>
                                            <div class="box">
                                                <input type="radio" name="tipo_professor" id="Professor" value="P" checked>
        ...
        <div class="row box-tabela">
            <table class="table table-striped acoes-inline">
                ...
                <tbody>
                    <tr>
                        <?php
                        foreach ($listarProfessores as $cod => $nome) {
                            echo"
                            <tr>
                                <td>$cod</td>
                                <td>$nome</td>
                                <td>$listarEmail[$cod]</td>
                                <td>$listarIdSenac[$cod]</td>
                                <td>
