...
<head>
    ...
    <title>Listagem dos Assuntos</title>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <p class="modal-title">Digite as informa&ccedil;&otilde;es do <span class="destaque">Assunto</span> que Deseja Adicionar</p>
                                </div>
                                <div class="modal-body">
                                    <form method="post">
                                        <div class="box-frm-campos">
                                            <input type="text" name="assunto" required>
                                            <span class="floating-label">Assunto:</span>
                                        </div>
                                        <div class="box-frm-campos">
        ...
        <div class="row box-tabela">
            <table class="table table-striped acoes-inline">
                ...
                <tbody>
                    <tr>
                        <?php
                        foreach ($listarAssuntos as $cod => $assunto) {
                            echo "<tr>
                            <td>$cod</td>
                            <td>$assunto</td>
                            <td>$areas[$cod]</td>
                            <td><a href = '?ecod=$cod' class='acoes editar' data-toggle='modal' data-target='#modalEditar'><span class='glyphicon glyphicon-pencil'></span>Editar</a></td>
                            <td><a href = '?dcod=$cod' class='acoes excluir'><span class='glyphicon glyphicon-trash'></span>Excluir</a></td>
                        </tr>";
                    }
                    ?>
                </tr>
